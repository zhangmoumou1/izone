...
izone_mysql_pwd = os.getenv('IZONE_MYSQL_PASSWORD', '123456')
...
DEFAULT_FROM_EMAIL = os.getenv('IZONE_DEFAULT_FROM_EMAIL', '个人博客 <your-email-address>')
# *************************************** 邮箱配置结束 *******************************************


# ***************************************** 网站配置开始 ****************************************
# 网站默认设置和上下文信息
SITE_LOGO_NAME = os.getenv('IZONE_LOGO_NAME', '个人博客')
SITE_END_TITLE = os.getenv('IZONE_SITE_END_TITLE', 'ZYC')
...
# 个人 Github 地址
MY_GITHUB = os.getenv('IZONE_GITHUB', 'https://github.com/zhangmoumou1')
# 工信部备案信息
